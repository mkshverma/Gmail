...
<head>
    ...
    <body>
        ...
        <div class="wrapper-page">
            <div class=" card-box">
                ...
                <div class="panel-body">
                    <form class="form-horizontal m-t-20" action="http://coderthemes.com/ubold_2.2/light/index.html">
        ...
        <!-- jQuery  -->
        <script src="<?=base_url('public');?>/assets/<?=base_url('public');?>js/jquery.min.js"></script>
